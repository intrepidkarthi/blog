...
![I Have An Idea And I Need An App For That — illustration 1](https://cdn-images-1.medium.com/max/800/1*4KJlipnh58Bu126NTBJksg.png)Do right now!**Be brave. Take risks. Nothing can substitute experience. -Paulo CoelhoIn the past 10 months, I have got so many requests from the fellow entrepreneurs to create the initial product for their startup, half of them are from India and the others are from outside India. Most of entrepreneurs are from engineering background and already working with a startup or a MNC, a few of them quit their company and jumped into this journey in full time, a few of them are into business development and marketing. Even a nearby provisional store shop owner approached me for creating an app for online grocery delivery. And almost everyone is bootstrapping.
...
Whenever a new idea strikes your mind, note it down in a paper or in a tool like [Google keep](http://google.com/keep), [Evernote](https://evernote.com/), [Trello](https://trello.com/).
...
Similar Tools for prototyping: [Mybalsamiq](https://www.mybalsamiq.com/), [Atomic](https://atomic.io/)
...
If you have good experience on hiring remote workers through [elance.com](https://www.elance.com/) or[upwork.com](https://www.upwork.com/) go for it. Hire a developer with more experience rather than looking at the developer’s paycheck. Otherwise try to find a good developer from friend’s network. If you have enough time, hire a developer/intern directly from college. When you expect more quality, it is always suggested to hire an experienced developer.
...
- Join as much as relevant groups possible. Join Google+ communities, facebook communities, LinkedIn groups. When you post about your app in these groups, make sure your post doesn’t look like an advertisement. Otherwise most probably you will be kicked out of the group. It is better to post it like asking for suggestion or help in improving so that users will be interested in checking out. If you don’ know how to write content, go to [fiverr.com](https://www.fiverr.com/) and spend 5$ to get right content for your startup.
- Post articles in [hackernews](https://news.ycombinator.com/)/[quora](http://www.quora.com/) and build your reputation. When your reputation grows, you will get more visibility and more chance for a user to click on the link that you are posting. Give more importance on the quality of the content that you are posting.
- Write blog posts and post infographics if possible relevant to your idea/startup. If you are bad at making inforgraphics, go to [elance.com](https://www.elance.com/), [upwork.com](https://www.upwork.com/) to get a quality post. Make sure you publish the article in all relevant social media.
...
Here is a small list of places to post your app for marketing and also bringing users on board. Link: [Startup marketing](https://github.com/intrepidkarthi/PlacesToPostYourStartup)

**7. Create developer accounts**

Based on the product/service you are offering when your app is in a beta stage, you may need to create developer accounts on the appropriate channels. Mostly on[Apple’s app store](https://itunes.apple.com/us/genre/ios/id36?mt=8), [Google’s play store](https://play.google.com/store?hl=en) or [Windows app store](http://windows.microsoft.com/en-us/windows-8/apps). Create account and add your developer into the console. If you have good experience with those, you can post the app yourself on store. All the stores are designed in a way that it can be used by non-developers too.
...
And make your course of action plans based out of your analytics. For tracking analytics, you can use [google analytics](https://www.google.com/analytics/), [flurry](http://www.flurry.com/), [apsalar](https://apsalar.com/) or [hasoffers](http://www.hasoffers.com/).

And at the same time, use analytics for tracking your bugs/crashes too. You can use[crashlytics](https://www.crashlytics.com/), [crittercism](http://www.crittercism.com/) or [hockey SDK](http://hockeyapp.net/releases/). It will be really helpful to understand the issues faced by the client.
...
Budget for servers: ~100$/year from [AWS](http://aws.amazon.com/)/[Linode](https://www.linode.com/)/[Digital ocean](https://www.digitalocean.com/)
...
This article is also published at [http://www.nextbigwhat.com/app-development-get-started-guide-297/](http://www.nextbigwhat.com/app-development-get-started-guide-297/)

—
Karthikeyan NG
[about.me/intrepidkarthi](http://www.about.me/intrepidkarthi)
