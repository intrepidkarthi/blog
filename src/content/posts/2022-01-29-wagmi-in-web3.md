...
tags: [crypto, web3, blockchain, trading]
source: medium
...
![WAGMI in Web3 — illustration 1](https://cdn-images-1.medium.com/max/800/1*_vKBAzJkgt2yuUlOT9qReQ.png)Decoupling a few queries about the Web3 eco system as simple as possible based on the attempt of deploying a couple of dApps as a hobby project, investing in crypto coins and owning a few NFTs.

IRL, people who holds BTC(Bitcoin) can be assumed to be a citizen of the Bitcoin Country. Because they can use the coins to exchange it to other users on the digital world for a physical item. Bitcoin is accepted as a legal tender by the country El Salvador. BTC is literal equivalent of fiat currencies but for the digital world. The person who holds ETH(Ethereum) belongs to Ethereum country. But unlike Bitcoin country, ETH is a union of multiple regions which runs its owns Cryptocurrencies(ex: Matic, Loopring) and also it is interoperable within Ethereum eco system. Other than Bitcoin and Ethereum, there are thousands of other coins available in the [market](https://coinmarketcap.com/).
...
![WAGMI in Web3 — illustration 2](https://cdn-images-1.medium.com/max/800/0*iNS8cLMce02Q908K)Web3 in nutshell revolves about decentralising the authority of the system and everyone will have a say in the system unlike traditional systems and institutions. Web3 is mainly driving new business models and incentive mechanisms rather than changing the current Internet architecture.

***Web3 doesn’t mean that every other system which is alive currently will be replaced by a new system. At least we are not there yet.*![WAGMI in Web3 — illustration 3](https://cdn-images-1.medium.com/max/800/0*oPq3KHkEbeH_8orn)All the Web3 apps or dApps(Decentralised apps) are built on alt-coins (Coins other than Bitcoin) like Ethereum, Solana, Polygon, etc.,
...
- The applications run on the chain is called Smart Contracts written in Solidity(ETH based coins) language. There are many resources if you closely follow “Web3 twitter/reddit” space.
- If you are a python or javascript developer or even if you are a non-programmer, checkout: [https://thirdweb.com/](https://thirdweb.com/)
- There is a course on [coursera](https://www.coursera.org/learn/mastering-web3-waves)
- To start as a blockchain developer from the scratch: [http://openquest.xyz/](http://openquest.xyz/) & [https://buildspace.so/](https://buildspace.so/) They have an awesome dev community around them
- Documentation for DIY developers: [https://docs.openzeppelin.com/openzeppelin/](https://docs.openzeppelin.com/openzeppelin/)
...
No, there are many artists who were making money in the real world, made more money in the digital world by selling digital version of their creations(music, drawings, digital arts). But they are all early adopters into the system. Some of the digital creations are worth millions. Twitter founder Jack sold his tweet for millions([link](https://www.cnbc.com/2021/03/22/jack-dorsey-sells-his-first-tweet-ever-as-an-nft-for-over-2point9-million.html)). Is it actually worth that much? We can’t say. But certainly all the currently trending animal pic NFTs(Apes, Gorillas, Cats, Dragons) will have its dead line once the actual use cases emerge.

> *Holding animal pics as an NFT is equivalent to an unknown company naming a star after you! The focus should move towards actual use cases.*

I could be crucified for saying the above fact by the NFT crusaders. NFT is the main reason how people are getting onboarded into the Web3 world(shown in the google trends below). But NFT art sets bad example for the eco system. Use cases will evolve. Look at the following NFT from the popular collection “Bored Ape Yacht Club”. Images are not actually stored on the chain but only the meta data due to its high gas fees(transaction cost). It means that the picture can be altered anytime by a third party controller. You own the NFT until someone hacks the system. If the core problems are not fixed, definitely this is NGMI.

![WAGMI in Web3 — illustration 5](https://cdn-images-1.medium.com/max/800/0*K3Eg8GdFToelI_EZ)Anything you see or you have on your computer can be an NFT and you can claim you are the only owner. This is very early market for NFT. There are many use cases. It can be used as an authentication and authorisation mechanism to let a user into a house, group, event, concert, etc., Even academic degree certificates can be replaced by NFTs.

> *NFT brings in one aspect that you can own a digital asset and trace its origin which was not the case earlier.*

NFTs has an awesome use case in the Metaverse(virtual alternative to physical world) to build props for the environment. It is same as building your own farm in Farmville game with collectibles and paid properties. There are a few communities building platforms on creating digital equivalent of real estates and virtual [worlds](https://decentraland.org/).

### How secure is your Crypto wallet compared to the money in a bank account?

Cryptocurrency as an investment instrument seems very lucrative due to its incentives which is subject to multiple risks. Crypto wallets holds a private key which secures your data in the local machine and enables your interaction online. There are new type of thefts happening every day. There is a huge list of thefts in the history ([Wikipedia](https://en.wikipedia.org/wiki/Cryptocurrency_and_crime)). You can use a physical [hardware wallet](https://www.ledger.com/) to keep your coins safe. But you need to read more from official sources and be very careful especially when you do any transaction in the system. A lot of privacy and security standards are yet to be established.

### Does Bitcoin and other chains consume more energy?

Yes, it does. Earlier Internet connection sucks, remember dial up connection. Look at the [average connection speed](https://www.speedtest.net/global-index) across the globe. Try calculating the power consumption of Meta’s new AI super computer — RSC stack is going to have 21000 Nvidia V100 GPUs to run their new platform. In fact this problem pushes companies to innovate on faster processing speeds as well as the need for alternative energy sources. Technologies will evolve and optimise.
...
It was difficult to understand Internet [25 years ago](https://www.newstatesman.com/science-tech/2016/08/25-years-here-are-worst-ever-predictions-about-internet). Mobile based Web3 use cases will onboard users in a rate higher than we ever imagined. Web3 is still catching up with user’s interest compared to other terms in the eco system.

![WAGMI in Web3 — illustration 6](https://cdn-images-1.medium.com/max/800/0*WupDLOHdK_DRRnTv)Web1** — Opened up Internet. Services built and was made common for all the users across the internet
...
![WAGMI in Web3 — illustration 7](https://cdn-images-1.medium.com/max/800/0*EZGvMKWRdQcAl_nF)Web3 is here to stay and in its nascent state. Web3 challenges existing policies, systems & institutions and pushes the tech world to innovate further on faster computing speeds.

The article is published in Linkedin Pulse [here](http://linkedin.com/pulse/wagmi-web3-karthikeyan-ng)

Hit me up if there is anything misquoted in the article :)
